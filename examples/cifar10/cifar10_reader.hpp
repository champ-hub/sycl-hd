 ...
 */
    ...
    void read_test(std::size_t limit, Images &images, Labels &labels, Functor func) {
        read_test(PROJECT_PATH_CMAKE "/examples/cifar10/datasets", limit, images, labels, func);
    }
 ...
 */
    ...
    void read_training(std::size_t limit, Images &images, Labels &labels, Functor func) {
        read_training(PROJECT_PATH_CMAKE "/examples/cifar10/datasets", limit, images, labels, func);
    }
 ...
 */
    ...
    void read_cifar10_file_categorical(Images &images, Labels &labels, const std::string &path, std::size_t limit,
                                       size_t start) {
 ...
 */
    ...
    void read_training_categorical(std::size_t limit, Images &images, Labels &labels) {
        read_training_categorical(PROJECT_PATH_CMAKE "/examples/cifar10/datasets", limit, images, labels);
    }
 ...
 */
    ...
    void read_test_categorical(std::size_t limit, Images &images, Labels &labels) {
        read_test_categorical(PROJECT_PATH_CMAKE "/examples/cifar10/datasets", limit, images, labels);
    }
 ...
 */
    ...
    CIFAR10_dataset<Container, Image, Label>
    read_dataset_3d(std::size_t training_limit = 0, std::size_t test_limit = 0) {
 ...
 */
    template<template<typename...> class Container, typename Image, typename Label = uint8_t>
    CIFAR10_dataset<Container, Image, Label>
    read_dataset_direct(std::size_t training_limit = 0, std::size_t test_limit = 0) {
        CIFAR10_dataset<Container, Image, Label> dataset;
 ...
 */
    template<template<typename...> class Container = std::vector,
            template<typename...> class Sub = std::vector, typename Pixel = uint8_t, typename Label = uint8_t>
    CIFAR10_dataset<Container, Sub<Pixel>, Label>
    read_dataset(std::size_t training_limit = 0, std::size_t test_limit = 0) {
